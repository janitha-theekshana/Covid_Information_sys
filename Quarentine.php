...
if($result_set){
    ...
    while($record = mysqli_fetch_assoc($result_set))
    {
        ...
        $table1 .='<td>'. $record['PCR_result'] . '</td>';
...
<html>
    ...
    <body onload="initClock()">
        <div class="container">
            <div class="navbar">
                <header>
                    ...
                    <ul class="navigation">
                        ...
                        <li><a href="Quarentine.php" onclick="toggleMenu();"  class="active">Quarentine</a></li>
            ...
            <div class="row">
                <div class="col">
                    <h1>covid-19 Quarantines</h1>
                    <p>Qurantine people details in Keradewala Grama Niladari Divison. 
                        We promise to give you the most accurate information.</p>
                </div>
                <div class="col">
                    <div class="card">
                       
                        <h3>Today Quarantine people</h3>
                        <label></label>
                        <?php
                            $date = date('Y-m-d');
                            $connection = mysqli_connect('localhost','root','','coviddb');

                            $query = "SELECT QP_ID FROM quarantine_people WHERE qurantine_start_date = '$date'";
                            ...
                            //$sql_query = "INSERT INTO quarantineGraph (id,TodayDate,peoples) VALUES ( 0,'$date', '$row')";
                            //$sql_query = "SELECT COUNT(id) FROM "
                            //$qr = mysqli_query($connection, $sql_query);
        ...
        <br><br>
        <section>
            <h3><u>Today Quarantine Details</u></h3><br><br>
    <main>
    <table class="center">
        <thead>
            <tr>
...
<br><br>
<section>
            <h3><u>Early Quarantine Details</u></h3><br><br>
    <main>
...
<style>
 .card{
    ...
    background-image: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url(corona.jpg);
    margin-left:50%;
} 
.card h3{
    text-align:center;
