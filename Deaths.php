...
if($result_set){
    ...
    while($record = mysqli_fetch_assoc($result_set))
    {
        ...
        $table .='<td>'. $record['death_reason'] . '</td>';
...
<html>
    ...
    <body onload="initClock()">
        <div class="container">
            <div class="navbar">
                <header>
                    ...
                    <ul class="navigation">
                        ...
                        <li><a href="Deaths.php" onclick="toggleMenu();" class="active">Deaths</a></li>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <p>Death people details in Keradewala Grama Niladari Divison. 
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <?php
                            ...
                            $query = "SELECT DP_ID FROM death_people WHERE Date = '$date'";
        ...
        <br><br>
        <section>
            <h3><u>Today Death Details</u></h3><br><br>
    <main>
    <table class="center">
        <thead>
            <tr>
...
<br><br>
<section>
            <h3><u>Early Death Details</u></h3><br><br>
    <main>
